...
void iterator_increment(Iterator* iterator) {
    ...
    iterator->pointer =
        (void*)((unsigned char*)iterator->pointer + iterator->element_size);
}
...
size_t iterator_index(Vector* vector, Iterator* iterator) {
    ...
    return ((unsigned char*)(iterator->pointer) -
            (unsigned char*)(vector->data)) /
           vector->element_size;
}
...
int _vector_move_right(Vector* vector, size_t index) {
    ...
    elements_in_bytes = (vector->size - index) * vector->element_size;
    ...
    memmove((unsigned char*)offset + vector->element_size,
            (unsigned char*)offset, elements_in_bytes);
    return VECTOR_SUCCESS;
#endif
}
...
void _vector_move_left(Vector* vector, size_t index) {
    ...
    memmove((unsigned char*)offset,
            (unsigned char*)offset + vector->element_size,
